...
public record PersonRecommendationResponse(
        ...
        @Schema(description = "답례 알림 예정일 (특정 대상이 없으면 null)", example = "2026-09-01") LocalDate reminderDate,
        @Schema(description = "답례일까지 남은 일수, 지났으면 음수 (특정 대상이 없으면 null)", example = "3") Integer daysLeft,
